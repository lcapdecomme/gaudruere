...
class ParametreContactType extends AbstractType
{
    public function buildForm(FormBuilder $builder, array $options)
    {
        $builder
            ->add('descriptionContact', 'textarea', array('attr' => array('class' => 'tinymce','data-theme' => 'medium', 'required' => true)));
    }

    public function getName()
    {
        return 'gaudruere_gitebundle_parametreContactType';
    }
